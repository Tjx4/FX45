...
import xyz.appic.core.helpers.toDayDataList
...
object HistoryComparator : DiffUtil.ItemCallback<PairHistoryTable>() {
    override fun areItemsTheSame(oldItem: PairHistoryTable, newItem: PairHistoryTable) = oldItem.tradingPair == newItem.tradingPair
