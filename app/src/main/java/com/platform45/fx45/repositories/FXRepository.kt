...
class FXRepository(private val retrofitHelper: RetrofitHelper, private val database: FX45Db, private val firebaseCrashlytics: FirebaseCrashlytics) : IFXRepository{
